...
class ConvDeconvEstimator(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('out_conv3', out_conv3.size())

        out_conv4 = self.conv4_1(self.conv4(out_conv3))
        # print('out_conv4', out_conv4.size())

        out_conv5 = self.conv5_1(self.conv5(out_conv4))
        # print('out_conv5', out_conv5.size())


        out_deconv4 = self.deconv4(out_conv5)
        # print('out_deconv4', out_deconv4.size())
        ...
        # print('out_conv3', out_conv3.size())
        # print('out_deconv3', out_deconv3.size())
